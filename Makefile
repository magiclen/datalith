...
./target/x86_64-unknown-linux-musl/release/$(EXECUTABLE_NAME): $(shell find . -type f -iname '*.rs' -o -name 'Cargo.toml' | sed 's/ /\\ /g') $(shell find ./front-end ./langs ./views ./data -type f | sed 's/ /\\ /g')
	PWD=$$(pwd)
